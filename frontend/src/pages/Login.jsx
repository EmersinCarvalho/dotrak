    ...
    <>
      ...
      <div className="login-page">
        <div className="login-split-container">
          {/* Left Side - Hero */}
          <div className="login-hero" style={{ backgroundImage: `url(${heroImage})` }}>
          ...
          <div className="login-form-container">
            <div className="login-form-wrapper">
              ...
              <div className="social-login">
                <button className="social-btn social-btn-white" aria-label="Sign up with Steam">
                ...
                <button className="social-btn social-btn-black" aria-label="Sign up with Discord">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p className="login-footer">
                {isLogin ? (
                  <>Don't have an account? <button onClick={() => setIsLogin(false)} className="link-btn">Sign up</button></>
                ) : (
